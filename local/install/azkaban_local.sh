...
## mysql 登录密钥
MYSQL_PASSWORD=$(grep MYSQL_Password ${CONF_DIR}/local_conf.properties|cut -d '=' -f2)
AZKABAN_DATABASE="azkaban"
## ssh密钥
SSL_PASSWORD=$(grep SSH_Password ${CONF_DIR}/local_conf.properties|cut -d '=' -f2)
...
mysql_ip=$(grep Mysql_InstallNode ${CONF_DIR}/local_conf.properties|cut -d '=' -f2)
...
AzkabanWebUI_Dir=$(grep WebUI_Dir ${CONF_DIR}/local_conf.properties|cut -d '=' -f2)
Install_IP=$(grep Mysql_InstallNode ${CONF_DIR}/local_conf.properties|cut -d '=' -f2)
